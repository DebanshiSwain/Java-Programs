/* Question 6 (AWT Counter):
Design an AWT GUI application. Each time the "Count" button is clicked, the counter value increases by 1; each time the "Reset" button is clicked, the counter is reset to zero.
*/
import java.awt.*;
